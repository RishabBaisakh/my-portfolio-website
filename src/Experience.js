      ...
      <Animated animationIn="slideInRight">
        <div className="experience__row myCardLayout">
          ...
          <ul className="experience__responsibilities">
            ...
            <li>
              <p>
                For the latter six months, I was given an opportunity to be a
                part of the development team for a migration product, as a
                frontend Angular 2+ developer.
              </p>
            </li>
            <li>
              <p>
                As a part of development team, I was working with a team of 7
